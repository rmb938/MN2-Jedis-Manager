...
public enum NetChannel {
    ...
    SERVER_TO_BUNGEE,
    SERVER_TO_SERVER,
    SERVER_TO_NETWORK_CONTROLLER,
    SERVER_TO_SERVER_CONTROLLER,

    //NETWORK CONTROLLER
    NETWORK_CONTROLLER_TO_BUNGEE,
    NETWORK_CONTROLLER_TO_SERVER,
    NETWORK_CONTROLLER_TO_SERVER_CONTROLLER,

    //SERVER CONTROLLER
    SERVER_CONTROLLER_TO_NETWORK_CONTROLLER,
